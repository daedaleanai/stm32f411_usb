...
enum IRQn_Type {
	...
	IRQ_RTC_Alarm          = 41, // RTC Alarms (A and B) through EXTI line interrupt
	IRQ_OTG_FS_WKUP        = 42, // USB On-The-Go FS Wakeup through EXTI line interrupt
	...
	IRQ_I2C3_ER            = 73, // I2C3 error interrupt
	IRQ_FPU                = 81, // Floating point unit interrupt
	IRQ_FPU                = 81, // FPU interrupt
	IRQ_FPU                = 81, // Floating point interrupt
...
inline struct GPIOB_Type* GPIOA_as_GPIOB_Type(struct GPIOA_Type* p) { return (struct GPIOB_Type*)p; }

inline struct GPIOH_Type* GPIOA_as_GPIOH_Type(struct GPIOA_Type* p) { return (struct GPIOH_Type*)p; }
...
// GPIOB->MODER GPIO port mode register
enum {
	GPIOB_MODER_MODER15 = ((1UL << 2) - 1) << 30, // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER14 = ((1UL << 2) - 1) << 28, // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER13 = ((1UL << 2) - 1) << 26, // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER12 = ((1UL << 2) - 1) << 24, // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER11 = ((1UL << 2) - 1) << 22, // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER10 = ((1UL << 2) - 1) << 20, // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER9  = ((1UL << 2) - 1) << 18, // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER8  = ((1UL << 2) - 1) << 16, // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER7  = ((1UL << 2) - 1) << 14, // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER6  = ((1UL << 2) - 1) << 12, // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER5  = ((1UL << 2) - 1) << 10, // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER4  = ((1UL << 2) - 1) << 8,  // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER3  = ((1UL << 2) - 1) << 6,  // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER2  = ((1UL << 2) - 1) << 4,  // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER1  = ((1UL << 2) - 1) << 2,  // Port x configuration bits (y = 0..15)
	GPIOB_MODER_MODER0  = ((1UL << 2) - 1) << 0,  // Port x configuration bits (y = 0..15)
};
inline void gpiob_moder_set_moder15(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER15) | ((val << 30) & GPIOB_MODER_MODER15);
}
inline void gpiob_moder_set_moder14(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER14) | ((val << 28) & GPIOB_MODER_MODER14);
}
inline void gpiob_moder_set_moder13(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER13) | ((val << 26) & GPIOB_MODER_MODER13);
}
inline void gpiob_moder_set_moder12(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER12) | ((val << 24) & GPIOB_MODER_MODER12);
}
inline void gpiob_moder_set_moder11(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER11) | ((val << 22) & GPIOB_MODER_MODER11);
}
inline void gpiob_moder_set_moder10(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER10) | ((val << 20) & GPIOB_MODER_MODER10);
}
inline void gpiob_moder_set_moder9(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER9) | ((val << 18) & GPIOB_MODER_MODER9);
}
inline void gpiob_moder_set_moder8(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER8) | ((val << 16) & GPIOB_MODER_MODER8);
}
inline void gpiob_moder_set_moder7(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER7) | ((val << 14) & GPIOB_MODER_MODER7);
}
inline void gpiob_moder_set_moder6(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER6) | ((val << 12) & GPIOB_MODER_MODER6);
}
inline void gpiob_moder_set_moder5(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER5) | ((val << 10) & GPIOB_MODER_MODER5);
}
inline void gpiob_moder_set_moder4(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER4) | ((val << 8) & GPIOB_MODER_MODER4);
}
inline void gpiob_moder_set_moder3(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER3) | ((val << 6) & GPIOB_MODER_MODER3);
}
inline void gpiob_moder_set_moder2(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER2) | ((val << 4) & GPIOB_MODER_MODER2);
}
inline void gpiob_moder_set_moder1(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER1) | ((val << 2) & GPIOB_MODER_MODER1);
}
inline void gpiob_moder_set_moder0(struct GPIOB_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOB_MODER_MODER0) | ((val << 0) & GPIOB_MODER_MODER0);
}
inline uint32_t gpiob_moder_get_moder15(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER15) >> 30; }
inline uint32_t gpiob_moder_get_moder14(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER14) >> 28; }
inline uint32_t gpiob_moder_get_moder13(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER13) >> 26; }
inline uint32_t gpiob_moder_get_moder12(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER12) >> 24; }
inline uint32_t gpiob_moder_get_moder11(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER11) >> 22; }
inline uint32_t gpiob_moder_get_moder10(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER10) >> 20; }
inline uint32_t gpiob_moder_get_moder9(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER9) >> 18; }
inline uint32_t gpiob_moder_get_moder8(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER8) >> 16; }
inline uint32_t gpiob_moder_get_moder7(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER7) >> 14; }
inline uint32_t gpiob_moder_get_moder6(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER6) >> 12; }
inline uint32_t gpiob_moder_get_moder5(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER5) >> 10; }
inline uint32_t gpiob_moder_get_moder4(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER4) >> 8; }
inline uint32_t gpiob_moder_get_moder3(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER3) >> 6; }
inline uint32_t gpiob_moder_get_moder2(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER2) >> 4; }
inline uint32_t gpiob_moder_get_moder1(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER1) >> 2; }
inline uint32_t gpiob_moder_get_moder0(struct GPIOB_Type* p) { return (p->MODER & GPIOB_MODER_MODER0) >> 0; }

// GPIOB->OTYPER GPIO port output type register
enum {
	GPIOB_OTYPER_OTX = ((1UL << 15) - 1) << 0, // Merged Port x configuration bits (y = 0..15)
};
inline void gpiob_otyper_set_otx(struct GPIOB_Type* p, uint32_t val) {
	p->OTYPER = (p->OTYPER & ~GPIOB_OTYPER_OTX) | ((val << 0) & GPIOB_OTYPER_OTX);
}
inline uint32_t gpiob_otyper_get_otx(struct GPIOB_Type* p) { return (p->OTYPER & GPIOB_OTYPER_OTX) >> 0; }

// GPIOB->OSPEEDR GPIO port output speed register
enum {
	GPIOB_OSPEEDR_OSPEEDR15 = ((1UL << 2) - 1) << 30, // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR14 = ((1UL << 2) - 1) << 28, // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR13 = ((1UL << 2) - 1) << 26, // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR12 = ((1UL << 2) - 1) << 24, // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR11 = ((1UL << 2) - 1) << 22, // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR10 = ((1UL << 2) - 1) << 20, // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR9  = ((1UL << 2) - 1) << 18, // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR8  = ((1UL << 2) - 1) << 16, // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR7  = ((1UL << 2) - 1) << 14, // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR6  = ((1UL << 2) - 1) << 12, // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR5  = ((1UL << 2) - 1) << 10, // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR4  = ((1UL << 2) - 1) << 8,  // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR3  = ((1UL << 2) - 1) << 6,  // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR2  = ((1UL << 2) - 1) << 4,  // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR1  = ((1UL << 2) - 1) << 2,  // Port x configuration bits (y = 0..15)
	GPIOB_OSPEEDR_OSPEEDR0  = ((1UL << 2) - 1) << 0,  // Port x configuration bits (y = 0..15)
};
inline void gpiob_ospeedr_set_ospeedr15(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR15) | ((val << 30) & GPIOB_OSPEEDR_OSPEEDR15);
}
inline void gpiob_ospeedr_set_ospeedr14(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR14) | ((val << 28) & GPIOB_OSPEEDR_OSPEEDR14);
}
inline void gpiob_ospeedr_set_ospeedr13(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR13) | ((val << 26) & GPIOB_OSPEEDR_OSPEEDR13);
}
inline void gpiob_ospeedr_set_ospeedr12(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR12) | ((val << 24) & GPIOB_OSPEEDR_OSPEEDR12);
}
inline void gpiob_ospeedr_set_ospeedr11(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR11) | ((val << 22) & GPIOB_OSPEEDR_OSPEEDR11);
}
inline void gpiob_ospeedr_set_ospeedr10(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR10) | ((val << 20) & GPIOB_OSPEEDR_OSPEEDR10);
}
inline void gpiob_ospeedr_set_ospeedr9(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR9) | ((val << 18) & GPIOB_OSPEEDR_OSPEEDR9);
}
inline void gpiob_ospeedr_set_ospeedr8(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR8) | ((val << 16) & GPIOB_OSPEEDR_OSPEEDR8);
}
inline void gpiob_ospeedr_set_ospeedr7(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR7) | ((val << 14) & GPIOB_OSPEEDR_OSPEEDR7);
}
inline void gpiob_ospeedr_set_ospeedr6(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR6) | ((val << 12) & GPIOB_OSPEEDR_OSPEEDR6);
}
inline void gpiob_ospeedr_set_ospeedr5(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR5) | ((val << 10) & GPIOB_OSPEEDR_OSPEEDR5);
}
inline void gpiob_ospeedr_set_ospeedr4(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR4) | ((val << 8) & GPIOB_OSPEEDR_OSPEEDR4);
}
inline void gpiob_ospeedr_set_ospeedr3(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR3) | ((val << 6) & GPIOB_OSPEEDR_OSPEEDR3);
}
inline void gpiob_ospeedr_set_ospeedr2(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR2) | ((val << 4) & GPIOB_OSPEEDR_OSPEEDR2);
}
inline void gpiob_ospeedr_set_ospeedr1(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR1) | ((val << 2) & GPIOB_OSPEEDR_OSPEEDR1);
}
inline void gpiob_ospeedr_set_ospeedr0(struct GPIOB_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOB_OSPEEDR_OSPEEDR0) | ((val << 0) & GPIOB_OSPEEDR_OSPEEDR0);
}
inline uint32_t gpiob_ospeedr_get_ospeedr15(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR15) >> 30; }
inline uint32_t gpiob_ospeedr_get_ospeedr14(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR14) >> 28; }
inline uint32_t gpiob_ospeedr_get_ospeedr13(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR13) >> 26; }
inline uint32_t gpiob_ospeedr_get_ospeedr12(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR12) >> 24; }
inline uint32_t gpiob_ospeedr_get_ospeedr11(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR11) >> 22; }
inline uint32_t gpiob_ospeedr_get_ospeedr10(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR10) >> 20; }
inline uint32_t gpiob_ospeedr_get_ospeedr9(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR9) >> 18; }
inline uint32_t gpiob_ospeedr_get_ospeedr8(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR8) >> 16; }
inline uint32_t gpiob_ospeedr_get_ospeedr7(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR7) >> 14; }
inline uint32_t gpiob_ospeedr_get_ospeedr6(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR6) >> 12; }
inline uint32_t gpiob_ospeedr_get_ospeedr5(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR5) >> 10; }
inline uint32_t gpiob_ospeedr_get_ospeedr4(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR4) >> 8; }
inline uint32_t gpiob_ospeedr_get_ospeedr3(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR3) >> 6; }
inline uint32_t gpiob_ospeedr_get_ospeedr2(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR2) >> 4; }
inline uint32_t gpiob_ospeedr_get_ospeedr1(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR1) >> 2; }
inline uint32_t gpiob_ospeedr_get_ospeedr0(struct GPIOB_Type* p) { return (p->OSPEEDR & GPIOB_OSPEEDR_OSPEEDR0) >> 0; }

// GPIOB->PUPDR GPIO port pull-up/pull-down register
enum {
	GPIOB_PUPDR_PUPDR15 = ((1UL << 2) - 1) << 30, // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR14 = ((1UL << 2) - 1) << 28, // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR13 = ((1UL << 2) - 1) << 26, // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR12 = ((1UL << 2) - 1) << 24, // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR11 = ((1UL << 2) - 1) << 22, // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR10 = ((1UL << 2) - 1) << 20, // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR9  = ((1UL << 2) - 1) << 18, // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR8  = ((1UL << 2) - 1) << 16, // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR7  = ((1UL << 2) - 1) << 14, // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR6  = ((1UL << 2) - 1) << 12, // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR5  = ((1UL << 2) - 1) << 10, // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR4  = ((1UL << 2) - 1) << 8,  // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR3  = ((1UL << 2) - 1) << 6,  // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR2  = ((1UL << 2) - 1) << 4,  // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR1  = ((1UL << 2) - 1) << 2,  // Port x configuration bits (y = 0..15)
	GPIOB_PUPDR_PUPDR0  = ((1UL << 2) - 1) << 0,  // Port x configuration bits (y = 0..15)
};
inline void gpiob_pupdr_set_pupdr15(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR15) | ((val << 30) & GPIOB_PUPDR_PUPDR15);
}
inline void gpiob_pupdr_set_pupdr14(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR14) | ((val << 28) & GPIOB_PUPDR_PUPDR14);
}
inline void gpiob_pupdr_set_pupdr13(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR13) | ((val << 26) & GPIOB_PUPDR_PUPDR13);
}
inline void gpiob_pupdr_set_pupdr12(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR12) | ((val << 24) & GPIOB_PUPDR_PUPDR12);
}
inline void gpiob_pupdr_set_pupdr11(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR11) | ((val << 22) & GPIOB_PUPDR_PUPDR11);
}
inline void gpiob_pupdr_set_pupdr10(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR10) | ((val << 20) & GPIOB_PUPDR_PUPDR10);
}
inline void gpiob_pupdr_set_pupdr9(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR9) | ((val << 18) & GPIOB_PUPDR_PUPDR9);
}
inline void gpiob_pupdr_set_pupdr8(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR8) | ((val << 16) & GPIOB_PUPDR_PUPDR8);
}
inline void gpiob_pupdr_set_pupdr7(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR7) | ((val << 14) & GPIOB_PUPDR_PUPDR7);
}
inline void gpiob_pupdr_set_pupdr6(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR6) | ((val << 12) & GPIOB_PUPDR_PUPDR6);
}
inline void gpiob_pupdr_set_pupdr5(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR5) | ((val << 10) & GPIOB_PUPDR_PUPDR5);
}
inline void gpiob_pupdr_set_pupdr4(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR4) | ((val << 8) & GPIOB_PUPDR_PUPDR4);
}
inline void gpiob_pupdr_set_pupdr3(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR3) | ((val << 6) & GPIOB_PUPDR_PUPDR3);
}
inline void gpiob_pupdr_set_pupdr2(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR2) | ((val << 4) & GPIOB_PUPDR_PUPDR2);
}
inline void gpiob_pupdr_set_pupdr1(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR1) | ((val << 2) & GPIOB_PUPDR_PUPDR1);
}
inline void gpiob_pupdr_set_pupdr0(struct GPIOB_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOB_PUPDR_PUPDR0) | ((val << 0) & GPIOB_PUPDR_PUPDR0);
}
inline uint32_t gpiob_pupdr_get_pupdr15(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR15) >> 30; }
inline uint32_t gpiob_pupdr_get_pupdr14(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR14) >> 28; }
inline uint32_t gpiob_pupdr_get_pupdr13(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR13) >> 26; }
inline uint32_t gpiob_pupdr_get_pupdr12(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR12) >> 24; }
inline uint32_t gpiob_pupdr_get_pupdr11(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR11) >> 22; }
inline uint32_t gpiob_pupdr_get_pupdr10(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR10) >> 20; }
inline uint32_t gpiob_pupdr_get_pupdr9(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR9) >> 18; }
inline uint32_t gpiob_pupdr_get_pupdr8(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR8) >> 16; }
inline uint32_t gpiob_pupdr_get_pupdr7(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR7) >> 14; }
inline uint32_t gpiob_pupdr_get_pupdr6(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR6) >> 12; }
inline uint32_t gpiob_pupdr_get_pupdr5(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR5) >> 10; }
inline uint32_t gpiob_pupdr_get_pupdr4(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR4) >> 8; }
inline uint32_t gpiob_pupdr_get_pupdr3(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR3) >> 6; }
inline uint32_t gpiob_pupdr_get_pupdr2(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR2) >> 4; }
inline uint32_t gpiob_pupdr_get_pupdr1(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR1) >> 2; }
inline uint32_t gpiob_pupdr_get_pupdr0(struct GPIOB_Type* p) { return (p->PUPDR & GPIOB_PUPDR_PUPDR0) >> 0; }

// GPIOB->IDR GPIO port input data register
enum {
	GPIOB_IDR_IDRX = ((1UL << 15) - 1) << 0, // Merged Port input data (y = 0..15)
};
inline uint32_t gpiob_idr_get_idrx(struct GPIOB_Type* p) { return (p->IDR & GPIOB_IDR_IDRX) >> 0; }

// GPIOB->ODR GPIO port output data register
enum {
	GPIOB_ODR_ODRX = ((1UL << 15) - 1) << 0, // Merged Port output data (y = 0..15)
};
inline void gpiob_odr_set_odrx(struct GPIOB_Type* p, uint32_t val) { p->ODR = (p->ODR & ~GPIOB_ODR_ODRX) | ((val << 0) & GPIOB_ODR_ODRX); }
inline uint32_t gpiob_odr_get_odrx(struct GPIOB_Type* p) { return (p->ODR & GPIOB_ODR_ODRX) >> 0; }

// GPIOB->BSRR GPIO port bit set/reset register
enum {
	GPIOB_BSRR_BR15 = 1UL << 31, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR14 = 1UL << 30, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR13 = 1UL << 29, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR12 = 1UL << 28, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR11 = 1UL << 27, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR10 = 1UL << 26, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR9  = 1UL << 25, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR8  = 1UL << 24, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR7  = 1UL << 23, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR6  = 1UL << 22, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR5  = 1UL << 21, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR4  = 1UL << 20, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR3  = 1UL << 19, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR2  = 1UL << 18, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR1  = 1UL << 17, // Port x reset bit y (y = 0..15)
	GPIOB_BSRR_BR0  = 1UL << 16, // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS15 = 1UL << 15, // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS14 = 1UL << 14, // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS13 = 1UL << 13, // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS12 = 1UL << 12, // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS11 = 1UL << 11, // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS10 = 1UL << 10, // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS9  = 1UL << 9,  // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS8  = 1UL << 8,  // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS7  = 1UL << 7,  // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS6  = 1UL << 6,  // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS5  = 1UL << 5,  // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS4  = 1UL << 4,  // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS3  = 1UL << 3,  // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS2  = 1UL << 2,  // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS1  = 1UL << 1,  // Port x set bit y (y= 0..15)
	GPIOB_BSRR_BS0  = 1UL << 0,  // Port x set bit y (y= 0..15)
};

// GPIOB->LCKR GPIO port configuration lock register
enum {
	GPIOB_LCKR_LCKK  = 1UL << 16, // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK15 = 1UL << 15, // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK14 = 1UL << 14, // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK13 = 1UL << 13, // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK12 = 1UL << 12, // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK11 = 1UL << 11, // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK10 = 1UL << 10, // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK9  = 1UL << 9,  // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK8  = 1UL << 8,  // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK7  = 1UL << 7,  // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK6  = 1UL << 6,  // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK5  = 1UL << 5,  // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK4  = 1UL << 4,  // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK3  = 1UL << 3,  // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK2  = 1UL << 2,  // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK1  = 1UL << 1,  // Port x lock bit y (y= 0..15)
	GPIOB_LCKR_LCK0  = 1UL << 0,  // Port x lock bit y (y= 0..15)
};

// GPIOB->AFRL GPIO alternate function low register
enum {
	GPIOB_AFRL_AFRL7 = ((1UL << 4) - 1) << 28, // Alternate function selection for port x bit y (y = 0..7)
	GPIOB_AFRL_AFRL6 = ((1UL << 4) - 1) << 24, // Alternate function selection for port x bit y (y = 0..7)
	GPIOB_AFRL_AFRL5 = ((1UL << 4) - 1) << 20, // Alternate function selection for port x bit y (y = 0..7)
	GPIOB_AFRL_AFRL4 = ((1UL << 4) - 1) << 16, // Alternate function selection for port x bit y (y = 0..7)
	GPIOB_AFRL_AFRL3 = ((1UL << 4) - 1) << 12, // Alternate function selection for port x bit y (y = 0..7)
	GPIOB_AFRL_AFRL2 = ((1UL << 4) - 1) << 8,  // Alternate function selection for port x bit y (y = 0..7)
	GPIOB_AFRL_AFRL1 = ((1UL << 4) - 1) << 4,  // Alternate function selection for port x bit y (y = 0..7)
	GPIOB_AFRL_AFRL0 = ((1UL << 4) - 1) << 0,  // Alternate function selection for port x bit y (y = 0..7)
};
inline void gpiob_afrl_set_afrl7(struct GPIOB_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOB_AFRL_AFRL7) | ((val << 28) & GPIOB_AFRL_AFRL7);
}
inline void gpiob_afrl_set_afrl6(struct GPIOB_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOB_AFRL_AFRL6) | ((val << 24) & GPIOB_AFRL_AFRL6);
}
inline void gpiob_afrl_set_afrl5(struct GPIOB_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOB_AFRL_AFRL5) | ((val << 20) & GPIOB_AFRL_AFRL5);
}
inline void gpiob_afrl_set_afrl4(struct GPIOB_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOB_AFRL_AFRL4) | ((val << 16) & GPIOB_AFRL_AFRL4);
}
inline void gpiob_afrl_set_afrl3(struct GPIOB_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOB_AFRL_AFRL3) | ((val << 12) & GPIOB_AFRL_AFRL3);
}
inline void gpiob_afrl_set_afrl2(struct GPIOB_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOB_AFRL_AFRL2) | ((val << 8) & GPIOB_AFRL_AFRL2);
}
inline void gpiob_afrl_set_afrl1(struct GPIOB_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOB_AFRL_AFRL1) | ((val << 4) & GPIOB_AFRL_AFRL1);
}
inline void gpiob_afrl_set_afrl0(struct GPIOB_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOB_AFRL_AFRL0) | ((val << 0) & GPIOB_AFRL_AFRL0);
}
inline uint32_t gpiob_afrl_get_afrl7(struct GPIOB_Type* p) { return (p->AFRL & GPIOB_AFRL_AFRL7) >> 28; }
inline uint32_t gpiob_afrl_get_afrl6(struct GPIOB_Type* p) { return (p->AFRL & GPIOB_AFRL_AFRL6) >> 24; }
inline uint32_t gpiob_afrl_get_afrl5(struct GPIOB_Type* p) { return (p->AFRL & GPIOB_AFRL_AFRL5) >> 20; }
inline uint32_t gpiob_afrl_get_afrl4(struct GPIOB_Type* p) { return (p->AFRL & GPIOB_AFRL_AFRL4) >> 16; }
inline uint32_t gpiob_afrl_get_afrl3(struct GPIOB_Type* p) { return (p->AFRL & GPIOB_AFRL_AFRL3) >> 12; }
inline uint32_t gpiob_afrl_get_afrl2(struct GPIOB_Type* p) { return (p->AFRL & GPIOB_AFRL_AFRL2) >> 8; }
inline uint32_t gpiob_afrl_get_afrl1(struct GPIOB_Type* p) { return (p->AFRL & GPIOB_AFRL_AFRL1) >> 4; }
inline uint32_t gpiob_afrl_get_afrl0(struct GPIOB_Type* p) { return (p->AFRL & GPIOB_AFRL_AFRL0) >> 0; }

// GPIOB->AFRH GPIO alternate function high register
enum {
	GPIOB_AFRH_AFRH15 = ((1UL << 4) - 1) << 28, // Alternate function selection for port x bit y (y = 8..15)
	GPIOB_AFRH_AFRH14 = ((1UL << 4) - 1) << 24, // Alternate function selection for port x bit y (y = 8..15)
	GPIOB_AFRH_AFRH13 = ((1UL << 4) - 1) << 20, // Alternate function selection for port x bit y (y = 8..15)
	GPIOB_AFRH_AFRH12 = ((1UL << 4) - 1) << 16, // Alternate function selection for port x bit y (y = 8..15)
	GPIOB_AFRH_AFRH11 = ((1UL << 4) - 1) << 12, // Alternate function selection for port x bit y (y = 8..15)
	GPIOB_AFRH_AFRH10 = ((1UL << 4) - 1) << 8,  // Alternate function selection for port x bit y (y = 8..15)
	GPIOB_AFRH_AFRH9  = ((1UL << 4) - 1) << 4,  // Alternate function selection for port x bit y (y = 8..15)
	GPIOB_AFRH_AFRH8  = ((1UL << 4) - 1) << 0,  // Alternate function selection for port x bit y (y = 8..15)
};
inline void gpiob_afrh_set_afrh15(struct GPIOB_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOB_AFRH_AFRH15) | ((val << 28) & GPIOB_AFRH_AFRH15);
}
inline void gpiob_afrh_set_afrh14(struct GPIOB_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOB_AFRH_AFRH14) | ((val << 24) & GPIOB_AFRH_AFRH14);
}
inline void gpiob_afrh_set_afrh13(struct GPIOB_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOB_AFRH_AFRH13) | ((val << 20) & GPIOB_AFRH_AFRH13);
}
inline void gpiob_afrh_set_afrh12(struct GPIOB_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOB_AFRH_AFRH12) | ((val << 16) & GPIOB_AFRH_AFRH12);
}
inline void gpiob_afrh_set_afrh11(struct GPIOB_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOB_AFRH_AFRH11) | ((val << 12) & GPIOB_AFRH_AFRH11);
}
inline void gpiob_afrh_set_afrh10(struct GPIOB_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOB_AFRH_AFRH10) | ((val << 8) & GPIOB_AFRH_AFRH10);
}
inline void gpiob_afrh_set_afrh9(struct GPIOB_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOB_AFRH_AFRH9) | ((val << 4) & GPIOB_AFRH_AFRH9);
}
inline void gpiob_afrh_set_afrh8(struct GPIOB_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOB_AFRH_AFRH8) | ((val << 0) & GPIOB_AFRH_AFRH8);
}
inline uint32_t gpiob_afrh_get_afrh15(struct GPIOB_Type* p) { return (p->AFRH & GPIOB_AFRH_AFRH15) >> 28; }
inline uint32_t gpiob_afrh_get_afrh14(struct GPIOB_Type* p) { return (p->AFRH & GPIOB_AFRH_AFRH14) >> 24; }
inline uint32_t gpiob_afrh_get_afrh13(struct GPIOB_Type* p) { return (p->AFRH & GPIOB_AFRH_AFRH13) >> 20; }
inline uint32_t gpiob_afrh_get_afrh12(struct GPIOB_Type* p) { return (p->AFRH & GPIOB_AFRH_AFRH12) >> 16; }
inline uint32_t gpiob_afrh_get_afrh11(struct GPIOB_Type* p) { return (p->AFRH & GPIOB_AFRH_AFRH11) >> 12; }
inline uint32_t gpiob_afrh_get_afrh10(struct GPIOB_Type* p) { return (p->AFRH & GPIOB_AFRH_AFRH10) >> 8; }
inline uint32_t gpiob_afrh_get_afrh9(struct GPIOB_Type* p) { return (p->AFRH & GPIOB_AFRH_AFRH9) >> 4; }
inline uint32_t gpiob_afrh_get_afrh8(struct GPIOB_Type* p) { return (p->AFRH & GPIOB_AFRH_AFRH8) >> 0; }

// Valid Casts:

inline struct GPIOA_Type* GPIOB_as_GPIOA_Type(struct GPIOB_Type* p) { return (struct GPIOA_Type*)p; }

inline struct GPIOH_Type* GPIOB_as_GPIOH_Type(struct GPIOB_Type* p) { return (struct GPIOH_Type*)p; }
...
// GPIOH->MODER GPIO port mode register
enum {
	GPIOH_MODER_MODER15 = ((1UL << 2) - 1) << 30, // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER14 = ((1UL << 2) - 1) << 28, // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER13 = ((1UL << 2) - 1) << 26, // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER12 = ((1UL << 2) - 1) << 24, // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER11 = ((1UL << 2) - 1) << 22, // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER10 = ((1UL << 2) - 1) << 20, // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER9  = ((1UL << 2) - 1) << 18, // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER8  = ((1UL << 2) - 1) << 16, // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER7  = ((1UL << 2) - 1) << 14, // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER6  = ((1UL << 2) - 1) << 12, // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER5  = ((1UL << 2) - 1) << 10, // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER4  = ((1UL << 2) - 1) << 8,  // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER3  = ((1UL << 2) - 1) << 6,  // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER2  = ((1UL << 2) - 1) << 4,  // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER1  = ((1UL << 2) - 1) << 2,  // Port x configuration bits (y = 0..15)
	GPIOH_MODER_MODER0  = ((1UL << 2) - 1) << 0,  // Port x configuration bits (y = 0..15)
};
inline void gpioh_moder_set_moder15(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER15) | ((val << 30) & GPIOH_MODER_MODER15);
}
inline void gpioh_moder_set_moder14(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER14) | ((val << 28) & GPIOH_MODER_MODER14);
}
inline void gpioh_moder_set_moder13(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER13) | ((val << 26) & GPIOH_MODER_MODER13);
}
inline void gpioh_moder_set_moder12(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER12) | ((val << 24) & GPIOH_MODER_MODER12);
}
inline void gpioh_moder_set_moder11(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER11) | ((val << 22) & GPIOH_MODER_MODER11);
}
inline void gpioh_moder_set_moder10(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER10) | ((val << 20) & GPIOH_MODER_MODER10);
}
inline void gpioh_moder_set_moder9(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER9) | ((val << 18) & GPIOH_MODER_MODER9);
}
inline void gpioh_moder_set_moder8(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER8) | ((val << 16) & GPIOH_MODER_MODER8);
}
inline void gpioh_moder_set_moder7(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER7) | ((val << 14) & GPIOH_MODER_MODER7);
}
inline void gpioh_moder_set_moder6(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER6) | ((val << 12) & GPIOH_MODER_MODER6);
}
inline void gpioh_moder_set_moder5(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER5) | ((val << 10) & GPIOH_MODER_MODER5);
}
inline void gpioh_moder_set_moder4(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER4) | ((val << 8) & GPIOH_MODER_MODER4);
}
inline void gpioh_moder_set_moder3(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER3) | ((val << 6) & GPIOH_MODER_MODER3);
}
inline void gpioh_moder_set_moder2(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER2) | ((val << 4) & GPIOH_MODER_MODER2);
}
inline void gpioh_moder_set_moder1(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER1) | ((val << 2) & GPIOH_MODER_MODER1);
}
inline void gpioh_moder_set_moder0(struct GPIOH_Type* p, uint32_t val) {
	p->MODER = (p->MODER & ~GPIOH_MODER_MODER0) | ((val << 0) & GPIOH_MODER_MODER0);
}
inline uint32_t gpioh_moder_get_moder15(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER15) >> 30; }
inline uint32_t gpioh_moder_get_moder14(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER14) >> 28; }
inline uint32_t gpioh_moder_get_moder13(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER13) >> 26; }
inline uint32_t gpioh_moder_get_moder12(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER12) >> 24; }
inline uint32_t gpioh_moder_get_moder11(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER11) >> 22; }
inline uint32_t gpioh_moder_get_moder10(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER10) >> 20; }
inline uint32_t gpioh_moder_get_moder9(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER9) >> 18; }
inline uint32_t gpioh_moder_get_moder8(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER8) >> 16; }
inline uint32_t gpioh_moder_get_moder7(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER7) >> 14; }
inline uint32_t gpioh_moder_get_moder6(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER6) >> 12; }
inline uint32_t gpioh_moder_get_moder5(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER5) >> 10; }
inline uint32_t gpioh_moder_get_moder4(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER4) >> 8; }
inline uint32_t gpioh_moder_get_moder3(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER3) >> 6; }
inline uint32_t gpioh_moder_get_moder2(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER2) >> 4; }
inline uint32_t gpioh_moder_get_moder1(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER1) >> 2; }
inline uint32_t gpioh_moder_get_moder0(struct GPIOH_Type* p) { return (p->MODER & GPIOH_MODER_MODER0) >> 0; }

// GPIOH->OTYPER GPIO port output type register
enum {
	GPIOH_OTYPER_OTX = ((1UL << 15) - 1) << 0, // Merged Port x configuration bits (y = 0..15)
};
inline void gpioh_otyper_set_otx(struct GPIOH_Type* p, uint32_t val) {
	p->OTYPER = (p->OTYPER & ~GPIOH_OTYPER_OTX) | ((val << 0) & GPIOH_OTYPER_OTX);
}
inline uint32_t gpioh_otyper_get_otx(struct GPIOH_Type* p) { return (p->OTYPER & GPIOH_OTYPER_OTX) >> 0; }

// GPIOH->OSPEEDR GPIO port output speed register
enum {
	GPIOH_OSPEEDR_OSPEEDR15 = ((1UL << 2) - 1) << 30, // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR14 = ((1UL << 2) - 1) << 28, // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR13 = ((1UL << 2) - 1) << 26, // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR12 = ((1UL << 2) - 1) << 24, // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR11 = ((1UL << 2) - 1) << 22, // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR10 = ((1UL << 2) - 1) << 20, // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR9  = ((1UL << 2) - 1) << 18, // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR8  = ((1UL << 2) - 1) << 16, // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR7  = ((1UL << 2) - 1) << 14, // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR6  = ((1UL << 2) - 1) << 12, // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR5  = ((1UL << 2) - 1) << 10, // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR4  = ((1UL << 2) - 1) << 8,  // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR3  = ((1UL << 2) - 1) << 6,  // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR2  = ((1UL << 2) - 1) << 4,  // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR1  = ((1UL << 2) - 1) << 2,  // Port x configuration bits (y = 0..15)
	GPIOH_OSPEEDR_OSPEEDR0  = ((1UL << 2) - 1) << 0,  // Port x configuration bits (y = 0..15)
};
inline void gpioh_ospeedr_set_ospeedr15(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR15) | ((val << 30) & GPIOH_OSPEEDR_OSPEEDR15);
}
inline void gpioh_ospeedr_set_ospeedr14(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR14) | ((val << 28) & GPIOH_OSPEEDR_OSPEEDR14);
}
inline void gpioh_ospeedr_set_ospeedr13(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR13) | ((val << 26) & GPIOH_OSPEEDR_OSPEEDR13);
}
inline void gpioh_ospeedr_set_ospeedr12(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR12) | ((val << 24) & GPIOH_OSPEEDR_OSPEEDR12);
}
inline void gpioh_ospeedr_set_ospeedr11(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR11) | ((val << 22) & GPIOH_OSPEEDR_OSPEEDR11);
}
inline void gpioh_ospeedr_set_ospeedr10(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR10) | ((val << 20) & GPIOH_OSPEEDR_OSPEEDR10);
}
inline void gpioh_ospeedr_set_ospeedr9(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR9) | ((val << 18) & GPIOH_OSPEEDR_OSPEEDR9);
}
inline void gpioh_ospeedr_set_ospeedr8(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR8) | ((val << 16) & GPIOH_OSPEEDR_OSPEEDR8);
}
inline void gpioh_ospeedr_set_ospeedr7(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR7) | ((val << 14) & GPIOH_OSPEEDR_OSPEEDR7);
}
inline void gpioh_ospeedr_set_ospeedr6(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR6) | ((val << 12) & GPIOH_OSPEEDR_OSPEEDR6);
}
inline void gpioh_ospeedr_set_ospeedr5(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR5) | ((val << 10) & GPIOH_OSPEEDR_OSPEEDR5);
}
inline void gpioh_ospeedr_set_ospeedr4(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR4) | ((val << 8) & GPIOH_OSPEEDR_OSPEEDR4);
}
inline void gpioh_ospeedr_set_ospeedr3(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR3) | ((val << 6) & GPIOH_OSPEEDR_OSPEEDR3);
}
inline void gpioh_ospeedr_set_ospeedr2(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR2) | ((val << 4) & GPIOH_OSPEEDR_OSPEEDR2);
}
inline void gpioh_ospeedr_set_ospeedr1(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR1) | ((val << 2) & GPIOH_OSPEEDR_OSPEEDR1);
}
inline void gpioh_ospeedr_set_ospeedr0(struct GPIOH_Type* p, uint32_t val) {
	p->OSPEEDR = (p->OSPEEDR & ~GPIOH_OSPEEDR_OSPEEDR0) | ((val << 0) & GPIOH_OSPEEDR_OSPEEDR0);
}
inline uint32_t gpioh_ospeedr_get_ospeedr15(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR15) >> 30; }
inline uint32_t gpioh_ospeedr_get_ospeedr14(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR14) >> 28; }
inline uint32_t gpioh_ospeedr_get_ospeedr13(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR13) >> 26; }
inline uint32_t gpioh_ospeedr_get_ospeedr12(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR12) >> 24; }
inline uint32_t gpioh_ospeedr_get_ospeedr11(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR11) >> 22; }
inline uint32_t gpioh_ospeedr_get_ospeedr10(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR10) >> 20; }
inline uint32_t gpioh_ospeedr_get_ospeedr9(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR9) >> 18; }
inline uint32_t gpioh_ospeedr_get_ospeedr8(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR8) >> 16; }
inline uint32_t gpioh_ospeedr_get_ospeedr7(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR7) >> 14; }
inline uint32_t gpioh_ospeedr_get_ospeedr6(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR6) >> 12; }
inline uint32_t gpioh_ospeedr_get_ospeedr5(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR5) >> 10; }
inline uint32_t gpioh_ospeedr_get_ospeedr4(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR4) >> 8; }
inline uint32_t gpioh_ospeedr_get_ospeedr3(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR3) >> 6; }
inline uint32_t gpioh_ospeedr_get_ospeedr2(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR2) >> 4; }
inline uint32_t gpioh_ospeedr_get_ospeedr1(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR1) >> 2; }
inline uint32_t gpioh_ospeedr_get_ospeedr0(struct GPIOH_Type* p) { return (p->OSPEEDR & GPIOH_OSPEEDR_OSPEEDR0) >> 0; }

// GPIOH->PUPDR GPIO port pull-up/pull-down register
enum {
	GPIOH_PUPDR_PUPDR15 = ((1UL << 2) - 1) << 30, // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR14 = ((1UL << 2) - 1) << 28, // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR13 = ((1UL << 2) - 1) << 26, // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR12 = ((1UL << 2) - 1) << 24, // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR11 = ((1UL << 2) - 1) << 22, // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR10 = ((1UL << 2) - 1) << 20, // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR9  = ((1UL << 2) - 1) << 18, // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR8  = ((1UL << 2) - 1) << 16, // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR7  = ((1UL << 2) - 1) << 14, // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR6  = ((1UL << 2) - 1) << 12, // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR5  = ((1UL << 2) - 1) << 10, // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR4  = ((1UL << 2) - 1) << 8,  // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR3  = ((1UL << 2) - 1) << 6,  // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR2  = ((1UL << 2) - 1) << 4,  // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR1  = ((1UL << 2) - 1) << 2,  // Port x configuration bits (y = 0..15)
	GPIOH_PUPDR_PUPDR0  = ((1UL << 2) - 1) << 0,  // Port x configuration bits (y = 0..15)
};
inline void gpioh_pupdr_set_pupdr15(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR15) | ((val << 30) & GPIOH_PUPDR_PUPDR15);
}
inline void gpioh_pupdr_set_pupdr14(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR14) | ((val << 28) & GPIOH_PUPDR_PUPDR14);
}
inline void gpioh_pupdr_set_pupdr13(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR13) | ((val << 26) & GPIOH_PUPDR_PUPDR13);
}
inline void gpioh_pupdr_set_pupdr12(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR12) | ((val << 24) & GPIOH_PUPDR_PUPDR12);
}
inline void gpioh_pupdr_set_pupdr11(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR11) | ((val << 22) & GPIOH_PUPDR_PUPDR11);
}
inline void gpioh_pupdr_set_pupdr10(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR10) | ((val << 20) & GPIOH_PUPDR_PUPDR10);
}
inline void gpioh_pupdr_set_pupdr9(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR9) | ((val << 18) & GPIOH_PUPDR_PUPDR9);
}
inline void gpioh_pupdr_set_pupdr8(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR8) | ((val << 16) & GPIOH_PUPDR_PUPDR8);
}
inline void gpioh_pupdr_set_pupdr7(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR7) | ((val << 14) & GPIOH_PUPDR_PUPDR7);
}
inline void gpioh_pupdr_set_pupdr6(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR6) | ((val << 12) & GPIOH_PUPDR_PUPDR6);
}
inline void gpioh_pupdr_set_pupdr5(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR5) | ((val << 10) & GPIOH_PUPDR_PUPDR5);
}
inline void gpioh_pupdr_set_pupdr4(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR4) | ((val << 8) & GPIOH_PUPDR_PUPDR4);
}
inline void gpioh_pupdr_set_pupdr3(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR3) | ((val << 6) & GPIOH_PUPDR_PUPDR3);
}
inline void gpioh_pupdr_set_pupdr2(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR2) | ((val << 4) & GPIOH_PUPDR_PUPDR2);
}
inline void gpioh_pupdr_set_pupdr1(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR1) | ((val << 2) & GPIOH_PUPDR_PUPDR1);
}
inline void gpioh_pupdr_set_pupdr0(struct GPIOH_Type* p, uint32_t val) {
	p->PUPDR = (p->PUPDR & ~GPIOH_PUPDR_PUPDR0) | ((val << 0) & GPIOH_PUPDR_PUPDR0);
}
inline uint32_t gpioh_pupdr_get_pupdr15(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR15) >> 30; }
inline uint32_t gpioh_pupdr_get_pupdr14(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR14) >> 28; }
inline uint32_t gpioh_pupdr_get_pupdr13(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR13) >> 26; }
inline uint32_t gpioh_pupdr_get_pupdr12(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR12) >> 24; }
inline uint32_t gpioh_pupdr_get_pupdr11(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR11) >> 22; }
inline uint32_t gpioh_pupdr_get_pupdr10(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR10) >> 20; }
inline uint32_t gpioh_pupdr_get_pupdr9(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR9) >> 18; }
inline uint32_t gpioh_pupdr_get_pupdr8(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR8) >> 16; }
inline uint32_t gpioh_pupdr_get_pupdr7(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR7) >> 14; }
inline uint32_t gpioh_pupdr_get_pupdr6(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR6) >> 12; }
inline uint32_t gpioh_pupdr_get_pupdr5(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR5) >> 10; }
inline uint32_t gpioh_pupdr_get_pupdr4(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR4) >> 8; }
inline uint32_t gpioh_pupdr_get_pupdr3(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR3) >> 6; }
inline uint32_t gpioh_pupdr_get_pupdr2(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR2) >> 4; }
inline uint32_t gpioh_pupdr_get_pupdr1(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR1) >> 2; }
inline uint32_t gpioh_pupdr_get_pupdr0(struct GPIOH_Type* p) { return (p->PUPDR & GPIOH_PUPDR_PUPDR0) >> 0; }

// GPIOH->IDR GPIO port input data register
enum {
	GPIOH_IDR_IDRX = ((1UL << 15) - 1) << 0, // Merged Port input data (y = 0..15)
};
inline uint32_t gpioh_idr_get_idrx(struct GPIOH_Type* p) { return (p->IDR & GPIOH_IDR_IDRX) >> 0; }

// GPIOH->ODR GPIO port output data register
enum {
	GPIOH_ODR_ODRX = ((1UL << 15) - 1) << 0, // Merged Port output data (y = 0..15)
};
inline void gpioh_odr_set_odrx(struct GPIOH_Type* p, uint32_t val) { p->ODR = (p->ODR & ~GPIOH_ODR_ODRX) | ((val << 0) & GPIOH_ODR_ODRX); }
inline uint32_t gpioh_odr_get_odrx(struct GPIOH_Type* p) { return (p->ODR & GPIOH_ODR_ODRX) >> 0; }

// GPIOH->BSRR GPIO port bit set/reset register
enum {
	GPIOH_BSRR_BR15 = 1UL << 31, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR14 = 1UL << 30, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR13 = 1UL << 29, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR12 = 1UL << 28, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR11 = 1UL << 27, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR10 = 1UL << 26, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR9  = 1UL << 25, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR8  = 1UL << 24, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR7  = 1UL << 23, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR6  = 1UL << 22, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR5  = 1UL << 21, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR4  = 1UL << 20, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR3  = 1UL << 19, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR2  = 1UL << 18, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR1  = 1UL << 17, // Port x reset bit y (y = 0..15)
	GPIOH_BSRR_BR0  = 1UL << 16, // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS15 = 1UL << 15, // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS14 = 1UL << 14, // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS13 = 1UL << 13, // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS12 = 1UL << 12, // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS11 = 1UL << 11, // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS10 = 1UL << 10, // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS9  = 1UL << 9,  // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS8  = 1UL << 8,  // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS7  = 1UL << 7,  // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS6  = 1UL << 6,  // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS5  = 1UL << 5,  // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS4  = 1UL << 4,  // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS3  = 1UL << 3,  // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS2  = 1UL << 2,  // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS1  = 1UL << 1,  // Port x set bit y (y= 0..15)
	GPIOH_BSRR_BS0  = 1UL << 0,  // Port x set bit y (y= 0..15)
};

// GPIOH->LCKR GPIO port configuration lock register
enum {
	GPIOH_LCKR_LCKK  = 1UL << 16, // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK15 = 1UL << 15, // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK14 = 1UL << 14, // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK13 = 1UL << 13, // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK12 = 1UL << 12, // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK11 = 1UL << 11, // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK10 = 1UL << 10, // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK9  = 1UL << 9,  // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK8  = 1UL << 8,  // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK7  = 1UL << 7,  // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK6  = 1UL << 6,  // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK5  = 1UL << 5,  // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK4  = 1UL << 4,  // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK3  = 1UL << 3,  // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK2  = 1UL << 2,  // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK1  = 1UL << 1,  // Port x lock bit y (y= 0..15)
	GPIOH_LCKR_LCK0  = 1UL << 0,  // Port x lock bit y (y= 0..15)
};

// GPIOH->AFRL GPIO alternate function low register
enum {
	GPIOH_AFRL_AFRL7 = ((1UL << 4) - 1) << 28, // Alternate function selection for port x bit y (y = 0..7)
	GPIOH_AFRL_AFRL6 = ((1UL << 4) - 1) << 24, // Alternate function selection for port x bit y (y = 0..7)
	GPIOH_AFRL_AFRL5 = ((1UL << 4) - 1) << 20, // Alternate function selection for port x bit y (y = 0..7)
	GPIOH_AFRL_AFRL4 = ((1UL << 4) - 1) << 16, // Alternate function selection for port x bit y (y = 0..7)
	GPIOH_AFRL_AFRL3 = ((1UL << 4) - 1) << 12, // Alternate function selection for port x bit y (y = 0..7)
	GPIOH_AFRL_AFRL2 = ((1UL << 4) - 1) << 8,  // Alternate function selection for port x bit y (y = 0..7)
	GPIOH_AFRL_AFRL1 = ((1UL << 4) - 1) << 4,  // Alternate function selection for port x bit y (y = 0..7)
	GPIOH_AFRL_AFRL0 = ((1UL << 4) - 1) << 0,  // Alternate function selection for port x bit y (y = 0..7)
};
inline void gpioh_afrl_set_afrl7(struct GPIOH_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOH_AFRL_AFRL7) | ((val << 28) & GPIOH_AFRL_AFRL7);
}
inline void gpioh_afrl_set_afrl6(struct GPIOH_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOH_AFRL_AFRL6) | ((val << 24) & GPIOH_AFRL_AFRL6);
}
inline void gpioh_afrl_set_afrl5(struct GPIOH_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOH_AFRL_AFRL5) | ((val << 20) & GPIOH_AFRL_AFRL5);
}
inline void gpioh_afrl_set_afrl4(struct GPIOH_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOH_AFRL_AFRL4) | ((val << 16) & GPIOH_AFRL_AFRL4);
}
inline void gpioh_afrl_set_afrl3(struct GPIOH_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOH_AFRL_AFRL3) | ((val << 12) & GPIOH_AFRL_AFRL3);
}
inline void gpioh_afrl_set_afrl2(struct GPIOH_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOH_AFRL_AFRL2) | ((val << 8) & GPIOH_AFRL_AFRL2);
}
inline void gpioh_afrl_set_afrl1(struct GPIOH_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOH_AFRL_AFRL1) | ((val << 4) & GPIOH_AFRL_AFRL1);
}
inline void gpioh_afrl_set_afrl0(struct GPIOH_Type* p, uint32_t val) {
	p->AFRL = (p->AFRL & ~GPIOH_AFRL_AFRL0) | ((val << 0) & GPIOH_AFRL_AFRL0);
}
inline uint32_t gpioh_afrl_get_afrl7(struct GPIOH_Type* p) { return (p->AFRL & GPIOH_AFRL_AFRL7) >> 28; }
inline uint32_t gpioh_afrl_get_afrl6(struct GPIOH_Type* p) { return (p->AFRL & GPIOH_AFRL_AFRL6) >> 24; }
inline uint32_t gpioh_afrl_get_afrl5(struct GPIOH_Type* p) { return (p->AFRL & GPIOH_AFRL_AFRL5) >> 20; }
inline uint32_t gpioh_afrl_get_afrl4(struct GPIOH_Type* p) { return (p->AFRL & GPIOH_AFRL_AFRL4) >> 16; }
inline uint32_t gpioh_afrl_get_afrl3(struct GPIOH_Type* p) { return (p->AFRL & GPIOH_AFRL_AFRL3) >> 12; }
inline uint32_t gpioh_afrl_get_afrl2(struct GPIOH_Type* p) { return (p->AFRL & GPIOH_AFRL_AFRL2) >> 8; }
inline uint32_t gpioh_afrl_get_afrl1(struct GPIOH_Type* p) { return (p->AFRL & GPIOH_AFRL_AFRL1) >> 4; }
inline uint32_t gpioh_afrl_get_afrl0(struct GPIOH_Type* p) { return (p->AFRL & GPIOH_AFRL_AFRL0) >> 0; }

// GPIOH->AFRH GPIO alternate function high register
enum {
	GPIOH_AFRH_AFRH15 = ((1UL << 4) - 1) << 28, // Alternate function selection for port x bit y (y = 8..15)
	GPIOH_AFRH_AFRH14 = ((1UL << 4) - 1) << 24, // Alternate function selection for port x bit y (y = 8..15)
	GPIOH_AFRH_AFRH13 = ((1UL << 4) - 1) << 20, // Alternate function selection for port x bit y (y = 8..15)
	GPIOH_AFRH_AFRH12 = ((1UL << 4) - 1) << 16, // Alternate function selection for port x bit y (y = 8..15)
	GPIOH_AFRH_AFRH11 = ((1UL << 4) - 1) << 12, // Alternate function selection for port x bit y (y = 8..15)
	GPIOH_AFRH_AFRH10 = ((1UL << 4) - 1) << 8,  // Alternate function selection for port x bit y (y = 8..15)
	GPIOH_AFRH_AFRH9  = ((1UL << 4) - 1) << 4,  // Alternate function selection for port x bit y (y = 8..15)
	GPIOH_AFRH_AFRH8  = ((1UL << 4) - 1) << 0,  // Alternate function selection for port x bit y (y = 8..15)
};
inline void gpioh_afrh_set_afrh15(struct GPIOH_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOH_AFRH_AFRH15) | ((val << 28) & GPIOH_AFRH_AFRH15);
}
inline void gpioh_afrh_set_afrh14(struct GPIOH_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOH_AFRH_AFRH14) | ((val << 24) & GPIOH_AFRH_AFRH14);
}
inline void gpioh_afrh_set_afrh13(struct GPIOH_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOH_AFRH_AFRH13) | ((val << 20) & GPIOH_AFRH_AFRH13);
}
inline void gpioh_afrh_set_afrh12(struct GPIOH_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOH_AFRH_AFRH12) | ((val << 16) & GPIOH_AFRH_AFRH12);
}
inline void gpioh_afrh_set_afrh11(struct GPIOH_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOH_AFRH_AFRH11) | ((val << 12) & GPIOH_AFRH_AFRH11);
}
inline void gpioh_afrh_set_afrh10(struct GPIOH_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOH_AFRH_AFRH10) | ((val << 8) & GPIOH_AFRH_AFRH10);
}
inline void gpioh_afrh_set_afrh9(struct GPIOH_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOH_AFRH_AFRH9) | ((val << 4) & GPIOH_AFRH_AFRH9);
}
inline void gpioh_afrh_set_afrh8(struct GPIOH_Type* p, uint32_t val) {
	p->AFRH = (p->AFRH & ~GPIOH_AFRH_AFRH8) | ((val << 0) & GPIOH_AFRH_AFRH8);
}
inline uint32_t gpioh_afrh_get_afrh15(struct GPIOH_Type* p) { return (p->AFRH & GPIOH_AFRH_AFRH15) >> 28; }
inline uint32_t gpioh_afrh_get_afrh14(struct GPIOH_Type* p) { return (p->AFRH & GPIOH_AFRH_AFRH14) >> 24; }
inline uint32_t gpioh_afrh_get_afrh13(struct GPIOH_Type* p) { return (p->AFRH & GPIOH_AFRH_AFRH13) >> 20; }
inline uint32_t gpioh_afrh_get_afrh12(struct GPIOH_Type* p) { return (p->AFRH & GPIOH_AFRH_AFRH12) >> 16; }
inline uint32_t gpioh_afrh_get_afrh11(struct GPIOH_Type* p) { return (p->AFRH & GPIOH_AFRH_AFRH11) >> 12; }
inline uint32_t gpioh_afrh_get_afrh10(struct GPIOH_Type* p) { return (p->AFRH & GPIOH_AFRH_AFRH10) >> 8; }
inline uint32_t gpioh_afrh_get_afrh9(struct GPIOH_Type* p) { return (p->AFRH & GPIOH_AFRH_AFRH9) >> 4; }
inline uint32_t gpioh_afrh_get_afrh8(struct GPIOH_Type* p) { return (p->AFRH & GPIOH_AFRH_AFRH8) >> 0; }

// Valid Casts:

inline struct GPIOA_Type* GPIOH_as_GPIOA_Type(struct GPIOH_Type* p) { return (struct GPIOA_Type*)p; }

inline struct GPIOB_Type* GPIOH_as_GPIOB_Type(struct GPIOH_Type* p) { return (struct GPIOB_Type*)p; }
...
struct GPIOA_Type         GPIOA;         // @0x40020000 Also: GPIOB_Type GPIOH_Type
struct GPIOB_Type         GPIOB;         // @0x40020400 Also: GPIOA_Type GPIOH_Type
struct GPIOH_Type         GPIOC;         // @0x40020800
struct GPIOH_Type         GPIOD;         // @0x40020C00
struct GPIOH_Type         GPIOE;         // @0x40021000
struct GPIOH_Type         GPIOH;         // @0x40021C00 Also: GPIOA_Type GPIOB_Type
